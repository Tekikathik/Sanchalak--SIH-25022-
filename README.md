...
Built for Smart India Hackathon problem statement SIH25022, "Maximizing section throughput through AI-powered, real-time train traffic control."

![Sanchalak control room](docs/screenshots/control-room.png)
